...
# ============================================================================
# YARD SETUP FOR DOCUMENTATION GENERATION
# ============================================================================
begin
  require "yard"
  ...
  # YARD not installed (e.g., in minimal environment)
  task :yard do
...
namespace :doc do
  ...
  task generate: :yard do
    ...
    puts "  Phase 3: YARD local generation (current)"
    puts ""
    puts "  Generated:"
    puts "  - HTML docs: doc/index.html"
    puts "  - RBS files: sig/generated/*.rbs"
    puts "  - Type checking: bundle exec steep check"
    puts ""
    puts "  View locally:"
    puts "  - Open doc/index.html in your browser"
    puts ""
    puts "  Publish to RubyGems:"
    puts "  - YARD docs auto-generated by RubyDoc.info: https://rubydoc.info/gems/picotorokko/"
  end
end
