...
class ManualOverrideIntegrationTest < Test::Unit::TestCase
  ...
  def test_rtc_methods_are_skipped_with_struct_references
    ...
    # Both methods should be skipped (return struct references)
    ...
    # RTC methods should not be generated (they return struct references)
    assert_not_includes content, 'gettime'
    assert_not_includes content, 'getdatetime'
  end
