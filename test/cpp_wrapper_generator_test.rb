...
class CppWrapperGeneratorTest < Test::Unit::TestCase
  def test_generate_method_with_no_parameters
    ...
    # Should generate: void m5unified_led_class_begin(void)
    # NOT: void m5unified_led_class_begin(void void)
    assert_match(/void m5unified_led_class_begin\(void\)/, result)
  ...
  def test_generate_method_with_parameters
    ...
    # Should generate: int m5unified_i2c_class_begin(int sda, int scl)
    assert_match(/int m5unified_i2c_class_begin\(int sda, int scl\)/, result)
  ...
  def test_generate_bool_return_converts_to_int
    ...
    assert_match(/int m5unified_button_class_waspressed\(void\)/, result)
  ...
  def test_generate_void_return_no_return_statement
    ...
    assert_match(/void m5unified_display_class_clear\(void\)/, result)
  ...
  def test_generate_const_method
    ...
    assert_match(/int m5unified_config_getvalue\(void\)/, result)
